...
Verified on 2026-07-21 after the DOSEN control correction:

- Node.js: v25.9.0.
- `npm run lint`: pass.
- `npm test`: pass, 11 files and 34 tests.
...
- `npm run crawl`: pass; all 13 known routes passed status/metadata/assets/console/internal-link checks and an unknown route returned HTTP 404.
...
| Test | Protects |
|---|---|
| `routes.test.jsx` | 5 static + 8 project route manifest |
...
| `projects-index.test.jsx` | eight-card display order |
...
| `stack.test.jsx` | eight stack cards and new-tab destinations |
...
- captures 14 route states (13 known + 404 probe) at five viewports.
